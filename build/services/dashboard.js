        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT firsTName,lastName,status,orders.id FROM users INNER JOIN orders ON users.id = orders.user_id';
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable get users and orders: ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    DashboardQueries.prototype.mostExpesive5 = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable get most 5 expensive products: ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
