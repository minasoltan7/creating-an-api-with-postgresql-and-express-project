...
var OrderModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cant get Order with id=".concat(id, ".Error:").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Can't create new order. Error ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Can't delete order with id=".concat(id, ". Error ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderModel.prototype.addProduct = function (quantiy, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [quantiy, orderId, productId])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
    ...
    // Metchod for showing all active orders of a specific user
    OrderModel.prototype.userCurrentOrders = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT order_id,product_id,quantity,user_id,status  FROM orders JOIN order_products ON orders.id=order_products.order_id  WHERE user_id=($1)  AND status='active' ";
                        return [4 /*yield*/, conn.query(sql, [id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not get current order of id ".concat(id, ": ").concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
