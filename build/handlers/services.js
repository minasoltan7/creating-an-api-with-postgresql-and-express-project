...
var usersInOrders = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.usersInOrders()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
...
var mostExpensive5 = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.mostExpesive5()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
