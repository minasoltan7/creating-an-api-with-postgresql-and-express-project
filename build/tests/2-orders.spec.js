...
var myOrder = new orders_1.OrderModel();
// Test suite for Orders Model methods
describe('testing if Orders methods', function () {
    ...
    it('testing if destroy method exist', function () {
        expect(myOrder.destroy).toBeDefined();
    });
    it('testing if addProduct method exist', function () {
        expect(myOrder.addProduct).toBeDefined();
    });
    it('testing if userCurrentOrders method exist', function () {
        expect(myOrder.userCurrentOrders).toBeDefined();
    });
    it('show method should return a specific order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, myOrder.show(1)];
                case 1:
                    result = _a.sent();
